...
\begin{figure}[ht]
	...
	\framebox{\parbox{5.0in}{
			\centering
			\includegraphics[width=0.6\textwidth]{figures/program.eps}}
	}
...
Outra importante propriedade a se considerar na implementação em controle digital é o que a literatura chama de efeitos de palavra finita (FWL, do ingles \textit{finite word length})~\cite{chang1994finite}. Devido ao foco desse trabalho levar em conta essa propriedade que muitas vezes é deixada de lado, falaremos com um pouco mais de detalhes como segue.
