...
Nesta dissertação foi apresentado uma metodologia de s[intese, bem como verificação de controladores digitais, considerando os efeitos de FWL na implementação de controladores. Como parte do processo de síntese, a verificação foi realizada de maneira formal, onde verificamos requisitos de desempenho como tempo de assentamento e sobressinal. Como parte do processo de síntese, a geração de candidatos, no caso controladores candidatos, foi feito através de problemas de otimização resolvido com algoritmo genético.
...
Nesta seção serão apresentadas algumas propostas para desenvolvimentos futuros relacionados à metodologia proposta descrita nesta dissertação. As propostas podem ser divididas em dois tipos de melhorias. A primeira é relacionada a parte de verificação e a segunda a síntese em si.
